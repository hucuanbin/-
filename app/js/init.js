...
window.nwjsUrlConfig = 'app/js/';
window.nwjsUrlConfig1 = 'dist/';
jQuery.getScript(window.nwjsUrlConfig + "linq.min.js");
jQuery.getScript(window.nwjsUrlConfig + "background.js");
